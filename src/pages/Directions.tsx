        ...
        <>
            ...
            <div
                ...
                <div className="h-full flex flex-col lg:flex-row justify-start lg:justify-center items-center">
                    <div
                        className="w-11/12 lg:w-4/12 h-1/3 lg:h-4/6 mt-10 lg:mt-0 shadow-2xl m-5 flex justify-center rounded-3xl items-center">
                    ...
                    <div
                        ...
                        <div className='flex justify-start flex-col'>
                            ...
                            <div className='font-normal text-sm lg:text-lg'>구미시외버스 터미널 : 171번 탑승 후 선산 터미널 도착 도보 5분거리
                            </div>
